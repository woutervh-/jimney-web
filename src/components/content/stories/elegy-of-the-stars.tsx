...
export class ElegyOfTheStars extends React.Component<{}, never> {
    renderDescription() {
        return <React.Fragment>
            <p>On the planet of Glast Oria's only missive is to survive, against the cold, the hunger, the Priests of the Seirios, the Administration of the planet, but when Quinn, another urchin, saves her life from the Administration and lets her stay in his hideout, her allegiance to only herself beings to change.</p>
